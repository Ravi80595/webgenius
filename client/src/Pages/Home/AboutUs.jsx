...
return (
    <Box background={'#edfaffa1'} pt={20}>
      <Flex>
        <Box w={'50%'}>
        <Image w={180} left={350} mt={20} position={'absolute'} src='https://demo.rstheme.com/wordpress/tekone/wp-content/uploads/2023/05/about-drone-img-h5.png'/>
        ...
        <Box w={'45%'}>
            ...
            <Flex mt={3} mb={10} justifyContent={'space-around'}>
            <Flex gap={5}><BsBookmarkCheckFill/> <Text>Internal Networking</Text></Flex>
            <Flex gap={5}><BsBookmarkCheckFill/> <Text>Internal Networking</Text></Flex>
            </Flex>
