...
return (
    <Box pt={100} background={'linear-gradient(0deg, rgba(255,255,255,1) 4%, rgba(228,254,254,1) 26%, rgba(164,236,232,0.8239670868347339) 52%, rgba(142,230,220,0.8323704481792717) 92%)'}>
        <Flex gap='50px' direction={['column-reverse','column-reverse','row','row']}>
            ...
            <Link to='/services'>
            <Button fontFamily={'"Open Sans", sans-serif'} mt={10} fontSize={'16px'} fontWeight={'bold'} p='19px 38px 19px 38px' backgroundImage={'linear-gradient(99.43deg, #513DE8 0.99%, #8366E3 99.43%)'} _hover={{color:'white'}} borderRadius={'30px'} color={'white'} lineHeight={'26px'}>SERVICES</Button></Link>
            <Button ml={5} fontFamily={'"Open Sans", sans-serif'} mt={10} fontSize={'16px'} fontWeight={'bold'} p='19px 38px 19px 38px' backgroundImage={'linear-gradient(99.43deg, #513DE8 0.99%, #8366E3 99.43%)'} _hover={{color:'white'}} borderRadius={'30px'} color={'white'} lineHeight={'26px'}>RECKONER</Button>
