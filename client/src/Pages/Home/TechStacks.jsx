...
return (
    <Box background={'#f8f8f8'} pt={'80px'} pb={'80px'}>
        <Flex justifyContent={'space-around'}>
            ...
            <Box box-shadow='rgba(0, 0, 0, 0.35) 0px 5px 15px' p='50px' background={'white'} borderRadius={20}>
                <Image w='70px' src='https://demo.rstheme.com/wordpress/tekone/wp-content/uploads/2023/05/atom.png'/>
            </Box>
            <Box p='50px' background={'white'} borderRadius={20}>
        ...
        <Box p='50px' background={'white'} borderRadius={20} >
            ...
            </Box> <Box p='50px' background={'white'} borderRadius={20}>
